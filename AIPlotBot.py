...
def handle_prompt(message):
    ...
    try:
        ...
        bot.send_message(message.from_user.id,"Произошла ошибка при подключении к серверу superset")
        return False
    ...
    try:
        ...
        bot.send_message(message.from_user.id,"Не удалось выполнить ваш запрос")
        return False
